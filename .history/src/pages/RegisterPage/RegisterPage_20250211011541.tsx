    ...
    <Box sx={{ display: "flex", justifyContent: "center", p: 3 }}>
      ...
      >
        ...
        <TextField
          ...
          onChange={handleChange}
          error={!!errMsg.apellido}
          helperText={errMsg.apellido}
        />
        <TextField
          label="Dirección"
          name="direccion"
          ...
          onChange={handleChange}
          error={!!errMsg.direccion}
          helperText={errMsg.direccion}
        />
        <TextField
          label="Correo"
          name="email"
        ...
        <Button type="submit" variant="contained" disabled={isLoading}>
          {" "}
          {isLoading ? "Cargando..." : "Registrarse"}e
        </Button>
           
      </Box>
    </Box>
