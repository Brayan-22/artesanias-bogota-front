...
const InventoryGeneralTable = () => {
 ...
 // const products = useAppSelector(selectAllProducts);
  const [detelteProductFromShop] = useDetelteProductFromShopMutation();
  ...
  const deleteProducts = () => {
    if (shopId) {
      if (confirm("Esta seguro que desea eliminae el producto")) {
        // await detelteProductFromShop({})
        selected.forEach(async (p) => {
          await detelteProductFromShop({ productId: p, shopId: shopId });
        });
      }
    }
  };
